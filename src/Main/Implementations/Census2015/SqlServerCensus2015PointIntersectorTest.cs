...
{
    [Serializable]
    public class SqlServerCensus2015PointIntersectorTest : AbstractCensus2015PointIntersectorTest
    {
        ...
        public SqlServerCensus2015PointIntersectorTest()
            : base()
        { }

        public SqlServerCensus2015PointIntersectorTest(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
        ...
        public override string GetSpatialIndex(bool GeometryIndexSelected, string Level1, string Level2, string Level3, string Level4, string tableName, double xmin, double ymin, double xmax, double ymax, string CellsPerObject)
        {
            ...
            if (GeometryIndexSelected)
            {
                ...
                {
                    spatialIndexCode = "CREATE SPATIAL INDEX " + Level1 + "_" + Level2 + "_" + Level3 + "_" + Level4 + "Geom   ON  [Tiger2015CensusBlocks].[dbo]." + tableName + "(shapeGeom ) USING GEOMETRY_GRID WITH (    BOUNDING_BOX = ( xmin=" + xmin + ", ymin=" + ymin + ", xmax=" + xmax + ", ymax=" + ymax + " ), GRIDS = (" + Level1 + "," + Level2 + "," + Level3 + "," + Level4 + "),    CELLS_PER_OBJECT = " + CellsPerObject + ");";

                }
                else if (tableName == "us_county10" || tableName == "us_MetDiv10" || tableName == "us_cbsa10")
                {
                    spatialIndexCode = "CREATE SPATIAL INDEX " + Level1 + "_" + Level2 + "_" + Level3 + "_" + Level4 + "Geom   ON  [Tiger2015CountryFiles].[dbo]." + tableName + "(shapeGeom )   USING GEOMETRY_GRID WITH (    BOUNDING_BOX = ( xmin=" + xmin + ", ymin=" + ymin + ", xmax=" + xmax + ", ymax=" + ymax + " ),  GRIDS = (" + Level1 + "," + Level2 + "," + Level3 + "," + Level4 + "),    CELLS_PER_OBJECT = " + CellsPerObject + ");";

                }
                else if (tableName.Contains("place10") || tableName.Contains("cousub10"))
                {
                    spatialIndexCode = "CREATE SPATIAL INDEX " + Level1 + "_" + Level2 + "_" + Level3 + "_" + Level4 + "Geom   ON  [Tiger2015StateFiles].[dbo]." + tableName + "(shapeGeom )   USING GEOMETRY_GRID WITH (    BOUNDING_BOX = ( xmin=" + xmin + ", ymin=" + ymin + ", xmax=" + xmax + ", ymax=" + ymax + " ),  GRIDS = (" + Level1 + "," + Level2 + "," + Level3 + "," + Level4 + "),    CELLS_PER_OBJECT = " + CellsPerObject + ");";
            ...
            else
            {
                if (tableName.Contains("tabblock10"))
                {
                    spatialIndexCode = "CREATE SPATIAL INDEX " + Level1 + "_" + Level2 + "_" + Level3 + "_" + Level4 + "Geog ON  [Tiger2015CensusBlocks].[dbo]." + tableName + "(shapeGeog) USING GEOGRAPHY_GRID WITH ( GRIDS = (" + Level1 + "," + Level2 + "," + Level3 + "," + Level4 + "),CELLS_PER_OBJECT = " + CellsPerObject + ");";
                }
                else if (tableName == "us_county10" || tableName == "us_MetDiv10" || tableName == "us_cbsa10")
                {
                    spatialIndexCode = "CREATE SPATIAL INDEX " + Level1 + "_" + Level2 + "_" + Level3 + "_" + Level4 + "Geog   ON  [Tiger2015CountryFiles].[dbo]." + tableName + "(shapeGeog)   USING GEOGRAPHY_GRID WITH ( GRIDS = (" + Level1 + "," + Level2 + "," + Level3 + "," + Level4 + "),CELLS_PER_OBJECT =" + CellsPerObject + ");";

                }
                else if (tableName.Contains("place10") || tableName.Contains("cousub10"))
                {
                    spatialIndexCode = "CREATE SPATIAL INDEX " + Level1 + "_" + Level2 + "_" + Level3 + "_" + Level4 + "Geog   ON  [Tiger2015StateFiles].[dbo]." + tableName + "(shapeGeog)   USING GEOGRAPHY_GRID WITH ( GRIDS = (" + Level1 + "," + Level2 + "," + Level3 + "," + Level4 + "),CELLS_PER_OBJECT = " + CellsPerObject + ");";
            ...
            for (int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 3; j++)
                {
                    for (int k = 0; k < 3; k++)
                    {
                        for (int l = 0; k < 3; k++)
                        {
                            SqlCommand cmd = new SqlCommand("DROP INDEX " + Grid_Densities[i] + "_" + Grid_Densities[j] + "_" + Grid_Densities[k] + "_" + Grid_Densities[l] + "Geom ON " + "[Tiger2015CensusBlocks].[dbo]." + TableName + ";DROP INDEX " + Grid_Densities[i] + "_" + Grid_Densities[j] + "_" + Grid_Densities[k] + "_" + Grid_Densities[l] + "Geog ON [Tiger2015CensusBlocks].[dbo]." + TableName + ";");
                            IQueryManager qm = StateFilesQueryManager;
                            int rows = qm.ExecuteNonQuery(CommandType.Text, cmd.CommandText, 10000000, true);
                        }
                    }
